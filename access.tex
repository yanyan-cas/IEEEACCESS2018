...
\title{Learning Electrocardiography Manifolds Toward Automated Arrhythmia Analysis}
\author{\uppercase{Yan Yan}\authorrefmark{1}, \IEEEmembership{Student Member, IEEE},
\uppercase{Lei Wang\authorrefmark{2}},
\IEEEmembership{Member, IEEE}}
\address[1]{Shenzhen Institutes of Advanced Technology, Chinese Academy of Sciences, and University of Chinese Academy of Sciences, 518055 China (e-mail: yan.yan@siat.ac.cn)}
\address[2]{Shenzhen Institutes of Advanced Technology, Chinese Academy of Sciences, and University of Chinese Academy of Sciences, 518055 China (e-mail: wang.lei@siat.ac.cn)}

\tfootnote{This work was supported by the National Natural Science Foundation of China, Grant No. 71531004.}

\markboth
{Yan \headeretal: Learning Electrocardiography Manifolds for Heartbeat Arrhythmia Analysis}
{Yan \headeretal: Learning Electrocardiography Manifolds for Heartbeat Arrhythmia Analysis}

\corresp{Corresponding author: Lei Wang (e-mail: wang.lei@siat.ac.cn).}
...
\begin{keywords}
ECG Classification, Machine Learning Application, Manifold Learning, Arrhythmia Analysis
\end{keywords}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{YY.pdf}}]{First A. Author} (M'76--SM'81--F'87) and all authors may include 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{WL.pdf}}]{Second B. Author} was born in Greenwich Village, New York, NY, USA in 
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{YY.pdf}}]{Third C. Author, Jr.} (M'87) received the B.S. degree in mechanical 
